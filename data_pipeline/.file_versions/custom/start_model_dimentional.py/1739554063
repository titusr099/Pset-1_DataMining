...
def transform_custom(*args, **kwargs):
    ...
    with Snowflake(
        ...
        create_table_queries = [
            """CREATE TABLE IF NOT EXISTS GOLD.FactOrderProducts (
            ...
            """CREATE TABLE IF NOT EXISTS GOLD.DimTime (
                time_key INTEGER AUTOINCREMENT PRIMARY KEY,
                order_dow INTEGER,
                order_dow_name STRING,
                order_hour_of_day INTEGER
            )""",
            """CREATE TABLE IF NOT EXISTS GOLD.DimUser (
        ...
        sf.export(df_dim_time, "GOLD.DimTime", if_exists="replace")
        sf.export(df_dim_user, "GOLD.DimUser", if_exists="replace")
        sf.export(df_dim_product, "GOLD.DimProduct", if_exists="replace")
        sf.export(df_fact_order_products, "GOLD.FactOrderProducts", if_exists="replace")
